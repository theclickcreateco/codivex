...
var middlewareSecret = "7aebdfcf-c7cd-4d9e-b9e3-52cfa0fb73ff";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "7aebdfcf-c7cd-4d9e-b9e3-52cfa0fb73ff") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
