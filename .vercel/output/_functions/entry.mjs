...
var middlewareSecret = "e1c1fe16-196c-4250-92fb-74bbc99562e0";
//#endregion
...
var _page1 = () => import("./chunks/contact_PL811VB5.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "e1c1fe16-196c-4250-92fb-74bbc99562e0") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
